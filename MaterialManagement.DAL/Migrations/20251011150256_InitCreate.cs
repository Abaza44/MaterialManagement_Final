        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesReturnInvoices_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentTo = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceRecords_Equipment_EquipmentCode",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientPayments_SalesInvoices_SalesInvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesInvoiceItems_Materials_MaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesReturnInvoiceItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalesReturnInvoiceItems_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesReturnInvoiceItems_SalesReturnInvoices_SalesReturnInvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseInvoiceItems_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPayments_SalesInvoiceId",
                table: "ClientPayments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRecords_EquipmentCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseInvoiceItems_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoiceItems_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesReturnInvoiceItems_MaterialId",
                table: "SalesReturnInvoiceItems",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesReturnInvoiceItems_SalesReturnInvoiceId",
                table: "SalesReturnInvoiceItems",
                column: "SalesReturnInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesReturnInvoices_ClientId",
                table: "SalesReturnInvoices",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesReturnInvoices_InvoiceNumber",
                table: "SalesReturnInvoices",
                column: "InvoiceNumber",
                unique: true);
